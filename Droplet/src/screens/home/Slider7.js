        ...
        <ScrollView style={styles.scrollContainer}>
          <View style={styles.container}>
            <View style={styles.box} hide={this.state.isHidden}>
              <Text style={styles.bottomText}>Where do you stand between in terms of general well-being? </Text>
              <Slider
                style={{ width: 300 }}
                step={1}
                minimumValue={0}
              ...
              <View style={styles.textCon}>
                <Text style={{marginLeft: -10,marginTop: -10,fontSize: 13,fontWeight: 'bold', color: 'red'}}>Not Satisfied</Text>
                <Text style={{marginRight: -10, marginTop: -10, fontSize: 13,fontWeight: 'bold',color: 'green'}}>Very Satisfied</Text>
              </View>
              ...
              <Button style={styles.prevButton} iconLeft info onPress={() => this.props.navigation.goBack()}>              
                ...
                <Button style={styles.nextButton} iconRight info onPress={() => this.props.navigation.navigate('EndSlider')}>
                  <Text>Next</Text>
                  <Ionicons
