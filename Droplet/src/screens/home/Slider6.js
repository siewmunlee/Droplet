        ...
        <ScrollView style={styles.scrollContainer}>
          <View style={styles.container}>
            <View style={styles.box} hide={this.state.isHidden}>
              ...
              <View style={styles.textCon}>
                <Text style={{marginLeft: -10,marginTop: -10,fontSize: 13,fontWeight: 'bold', color: 'red'}}>Not Alert</Text>
                <Text style={{marginRight: -10, marginTop: -10, fontSize: 13,fontWeight: 'bold',color: 'green'}}>Very Alert</Text>
              </View>
              ...
              <Button style={styles.prevButton} iconLeft info onPress={() => this.props.navigation.goBack()}>              
                ...
                <Button style={styles.nextButton} iconRight info onPress={() => this.props.navigation.navigate('Slider7')}>
                  <Text>Next</Text>
                  <Ionicons
