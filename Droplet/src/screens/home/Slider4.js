      ...
      <ScrollView style={styles.scrollContainer}>
        <View style={styles.container}>
          <View style={styles.box} hide={this.state.isHidden}>
            ...
            <View style={styles.textCon}>
              <Text style={styles.leftMarker}>Not Anxious</Text>
              <Text style={styles.rightMarker}>Very Anxious</Text>
            </View>
            ...
            <Button style={styles.prevButton} iconLeft info onPress={() => this.props.navigation.goBack()}>              
              ...
              <Button style={styles.nextButton} iconRight info onPress={() => this.props.navigation.navigate('Slider5')}>
                <Text>Next</Text>
                <Ionicons
